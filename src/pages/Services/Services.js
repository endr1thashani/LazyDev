    ...
    <div className='w-full max-w-[1240px] mx-auto items-center mt-[40px]'>
      ...
      <div className='w-full flex items-center justify-between flex-col p-[10px]'>
        <div className='flex flex-col p-[5px] items-center mb-[20px]' data-aos='zoom-in' data-aos-duration='1200'>
          <h1 className='font-bold text-[25px]  md:text-[52px] my-[20px]'>A Great user experience is <span className='primary'>Our Priority</span></h1>
        ...
        <img data-aos='zoom-out' data-aos-duration='1200' src={saly} alt='saly'/>
      </div>

      <div className='w-full flex items-center justify-between flex-col p-[10px] sm:flex-col md:flex-row mt-[70px]'>
        <div className='flex flex-col p-[5px] max-w-[500px]' data-aos='zoom-out' data-aos-duration='1200'>
          <h1 className='text-[#454749] font-bold text-[25px]  md:text-[40px]'>Web Development</h1>
          <p className='primary text-[18px] font-bold my-[10px]'>Website and Web App Development</p>
      ...
      <div className='w-full flex items-center justify-between flex-col p-[10px] sm:flex-col md:flex-row mt-[70px]'>
        ...
        <div className='flex flex-col p-[5px] max-w-[500px]' data-aos='zoom-out' data-aos-duration='1200' >
          <h1 className='text-[#454749] font-bold text-[25px] md:text-[40px]'>Progressive Mobile Apps</h1>
          <p className='primary text-[18px] font-bold my-[10px]'>Progressive app development</p>
      ...
      <div className='w-full flex items-center justify-between flex-col p-[10px] sm:flex-col md:flex-row mt-[70px]'>
        <div className='flex flex-col p-[5px] max-w-[500px]' data-aos='zoom-out' data-aos-duration='1200'>
          <h1 className='text-[#454749] font-bold text-[25px] md:text-[40px]'>User interface Design</h1>
          <p className='primary text-[18px] font-bold my-[10px]'>UI / UX design</p>
